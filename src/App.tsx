        ...
        <div className="flex items-center justify-between px-4 py-3 bg-[#111] border-b border-gray-800 shrink-0 cursor-grab active:cursor-grabbing">
          <div className="flex items-center gap-2">
            <div className="flex gap-2 mr-4 group">
              <button aria-label="Close terminal session" onClick={() => window.location.reload()} className="w-3 h-3 rounded-full bg-red-500/80 hover:bg-red-500 transition-colors" />
              <button aria-label={isMaximized ? "Restore window" : "Maximize window"} onClick={() => setIsMaximized(!isMaximized)} className="w-3 h-3 rounded-full bg-yellow-500/80 hover:bg-yellow-500 transition-colors" />
              <button aria-hidden="true" tabIndex={-1} className="w-3 h-3 rounded-full bg-green-500/80 hover:bg-green-500 transition-colors cursor-default" />
            </div>
          ...
          <button aria-label={isMaximized ? "Restore window" : "Maximize window"} onClick={() => setIsMaximized(!isMaximized)} className="text-gray-500 hover:text-white transition-colors">
