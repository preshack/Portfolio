          ...
          <div className="flex items-center gap-2">
            <div className="flex gap-2 mr-4 group">
              <button
                ...
                className="flex items-center justify-center w-3 h-3 rounded-full bg-red-500/80 hover:bg-red-500 transition-colors"
              >
              ...
              <button
                ...
                className="flex items-center justify-center w-3 h-3 rounded-full bg-yellow-500/80 hover:bg-yellow-500 transition-colors"
              >
              ...
              <button
                ...
                className="flex items-center justify-center w-3 h-3 rounded-full bg-green-500/80 hover:bg-green-500 transition-colors"
              >
                <Plus size={8} className="text-black/60 opacity-0 group-hover:opacity-100" />
              </button>
            </div>
