          ...
          <div className="flex items-center gap-2">
            <div className="flex gap-2 mr-4 group">
              <button
                ...
                className="w-3 h-3 flex items-center justify-center rounded-full bg-red-500/80 hover:bg-red-500 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-400"
              ...
              <button
                ...
                className="w-3 h-3 flex items-center justify-center rounded-full bg-yellow-500/80 hover:bg-yellow-500 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-yellow-400"
              ...
              <button
                ...
                className="w-3 h-3 flex items-center justify-center rounded-full bg-green-500/80 hover:bg-green-500 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-green-400"
