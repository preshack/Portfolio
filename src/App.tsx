        ...
        <div className="flex items-center justify-between px-4 py-3 bg-[#111] border-b border-gray-800 shrink-0 cursor-grab active:cursor-grabbing">
          <div className="flex items-center gap-2">
            <div className="flex gap-2 mr-4 group">
              ...
              >
                <X size={8} className="text-red-900 opacity-0 group-hover:opacity-100 transition-opacity" strokeWidth={4} />
              </button>
              <button
              ...
              >
                <Minus size={8} className="text-yellow-900 opacity-0 group-hover:opacity-100 transition-opacity" strokeWidth={4} />
              </button>
              <button
              ...
              >
                <Plus size={8} className="text-green-900 opacity-0 group-hover:opacity-100 transition-opacity" strokeWidth={4} />
              </button>
            </div>
